...
function Productitem({title,image,price} : TProduuct) {
  ...
  return (
    <>
        <section className='flex flex-col p-4 my-2 gap-2 text-center font-medium rounded-md shadow-[0_0_32px_0_var(--tw-shadow-color)] hover:shadow-[0_0_32px_16px_var(--tw-shadow-color)] shadow-slate-300 dark:shadow-slate-800 duration-300'>
