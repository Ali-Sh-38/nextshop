...
async function ProductPage(props : TProduuctPage) {
  ...
  return (
    <>
        <Container>
            <div className="w-full flex md:flex-row flex-col mt-8 p-4 border-y-4 border-slate-900">
                <div className='md:w-1/4 w-full'>
                    <img src={data.image}  alt="" />
                </div>
                <div className='md:w-3/4 w-full flex flex-col'>
                    <h1 className='text-[24px] font-medium text-slate-900'>{data.title}</h1>
                    <p className='text-blue-700 text-[32px] font-semibold p-2'>{data.price} $</p>
